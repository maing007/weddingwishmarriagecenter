...
<section class="story-banner">
    <div class="container">
        <h1>Mohsin and Misbah</h1>
        <p><strong>Home</strong> – Mohsin And Misbah</p>
    </div>
</section>
        ...
        <div class="row g-4">
                ...
                <div class="info-card">
                    ...
                    <div class="info-inner">
                        <table class="info-table">
                            <tr><td>Name</td><td>Misbah</td></tr>
                            <tr><td>Caste</td><td>Khokher</td></tr>
                            <tr><td>Profile Ow</td><td>Father</td></tr>
                            <tr><td>Age</td><td>28</td></tr>
                            <tr><td>Country</td><td>Pakistan</td></tr>
                            <tr><td>Occupation</td><td>BS Honors</td></tr>
                            <tr><td>Occupation</td><td>Job At Bank</td></tr>
            ...
            <div class="col-lg-6">
                <div class="info-card">
                    ...
                    <div class="info-inner">
                        <table class="info-table">
                            <tr><td>Name</td><td>Mohsin</td></tr>
                            <tr><td>Caste</td><td>Rajpot</td></tr>
                            <tr><td>Profile Ow</td><td>Mother</td></tr>
                            <tr><td>Age</td><td>28</td></tr>
                            <tr><td>Country</td><td>Pakistan</td></tr>
                            <tr><td>Education</td><td>BS Engineering</td></tr>
                            <tr><td>Occupation</td><td>Job At TOYOTA</td></tr>
                            <tr><td>Language</td><td>Punjabi</td></tr>
                        </table>
                    </div>
                </div>
