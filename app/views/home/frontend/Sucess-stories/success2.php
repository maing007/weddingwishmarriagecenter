...
<section class="story-banner">
    <div class="container">
        <h1>Ahmad and Aimal</h1>
        <p><strong>Home</strong> – Ahmad And Aimal</p>
    </div>
</section>
        ...
        <div class="row g-4">
                ...
                <div class="info-card">
                    ...
                    <div class="info-inner">
                        <table class="info-table">
                            <tr><td>Name</td><td>Ahmad</td></tr>
                            <tr><td>Profile Ow</td><td>Father</td></tr>
                            <tr><td>Age</td><td>25</td></tr>
                            <tr><td>Country</td><td>Pakistan</td></tr>
                            <tr><td>Education</td><td>BBA</td></tr>
                            <tr><td>Occupation</td><td>Owner Of Pakistan Famous Brand</td></tr>
            ...
            <div class="col-lg-6">
                <div class="info-card">
                    ...
                    <div class="info-inner">
                        <table class="info-table">
                            <tr><td>Name</td><td>Aimal</td></tr>
                            <tr><td>Profile Ow</td><td>Mother</td></tr>
                            <tr><td>Age</td><td>22</td></tr>
                            <tr><td>Country</td><td>Pakistan</td></tr>
                            <tr><td>Occupation</td><td>Lums Graduate</td></tr>
                            <tr><td>Occupation</td><td>CSS Qualified</td></tr>
